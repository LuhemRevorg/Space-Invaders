...
number_of_intial_enemies = 4
number_of_enemies = number_of_intial_enemies

for i in range(number_of_intial_enemies):
    enemyImg.append(pygame.image.load("enemy.png"))
    enemyX.append(enemyXi)
    enemyY.append(50)
    enemyX_delta.append(5)
    enemyY_delta.append(0)
    enemyXi += 184
    ...
    while running:
        ...
        for i in range(number_of_enemies):
            ...
            if collison(bulletX, enemyX[i], bulletY, enemyY[i]) is True:
                ...
                enemyX_delta.remove(enemyX_delta[i])
                enemyY_delta.remove(enemyY_delta[i])
                number_of_enemies -= 1
